...
if(!class_exists('meris_breadcrumb'))
{
	...
	function meris_breadcrumb($options = ""){
		...
		global $post;
		echo '<div class="meris-breadcrumb"><a href="'.get_bloginfo('url').'">';
			_e("Home",'meris');
			echo "</a>";
		...
		if(is_404()){ return _e("404 - Page not Found",'meris_framework'); }
		
		if(is_search()){ return _e("Search",'meris_framework');}	
