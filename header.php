...
$enable_search_form = meris_options_array('enable_search_form');
...
?>
	<div class="<?php echo $wrapper_class;?>">
        ...
        <img src="<?php echo meris_options_array('logo'); ?>" class="site-logo" alt="<?php bloginfo('name'); ?>" />
        </a>
        <?php } ?>
					<div class="name-box">
				...
				<form role="search" action="<?php echo esc_url(home_url('/')); ?>" class="search-form">
                   ...
                   <?php } else{
                   $menu_top = "margin-top:0px;" ; /*margin-top was 46px*/
                    } ?>
				<nav class="site-nav" role="navigation" style="<?php echo $menu_top ;?>">
					<?php
